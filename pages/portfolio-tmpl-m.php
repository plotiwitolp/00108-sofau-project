...
<div class="section portfolio-tmpl-m">
    ...
    <div class="wrap">
        <?php {
            $title1 = 'Style';
            $body1 = 'Match-3 helps users to relax and “kill time” during a long wait or trip. Fantasy images and a light plot are most preferable for this genre, so we paid attention to beautiful backgrounds that contribute to the pleasant emotions of our players.';
            $title2 = 'Backgrounds';
            $body2 = 'Winter forest thickets, snow-capped mountain ranges, fairy-tale motifs are the main component of the visual of our game. The studio\'s artists tried to convey the atmosphere of the plot filled with mystical and mysterious events as fully as possible.';
        }
        ?>
        <?php require $_SERVER['DOCUMENT_ROOT'] . '/templates/h2-info-two.php'; ?>
