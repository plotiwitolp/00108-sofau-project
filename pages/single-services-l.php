...
<div class="section">
    ...
    <div class="services">
        ...
        <section class="technical-exp">
            <h2><?php the_field('services_l_title_tech_h2'); ?></h2>
        ...
        <section class="our-works our-works_services">
            ...
            <div class="works-gallery">
                <div class="works-gallery__item wow animate__fadeInTopLeft" data-wow-duration="500ms">
                    <img class="desk_img full_for_img" src="<?php the_field('services_l_block_of_4_img_pic_desk_1'); ?>" alt="our_works-1">
                    <img class="full_img" src="<?php the_field('services_l_full_img_1'); ?>" alt="our_works-full">
                    <img class="mob_img" src="<?php the_field('services_l_block_of_4_img_pic_mob_1'); ?>" alt="our_works-1">
                </div>
                <div class="works-gallery__item wow animate__fadeInTopLeft" data-wow-duration="500ms">
                    <img class="desk_img full_for_img" src="<?php the_field('services_l_block_of_4_img_pic_desk_2'); ?>" alt="our_works-2">
                    <img class="full_img" src="<?php the_field('services_l_full_img_2'); ?>" alt="our_works-full">
                ...
                <div class="works-gallery__item wow animate__fadeInTopRight" data-wow-duration="500ms">
                    <img class="desk_img full_for_img" src="<?php the_field('services_l_block_of_4_img_pic_desk_3'); ?>" alt="our_works-3">
                    <img class="full_img" src="<?php the_field('services_l_full_img_3'); ?>" alt="our_works-full">
                    <img class="mob_img" src="<?php the_field('services_l_block_of_4_img_pic_mob_3'); ?>" alt="our_works-3">
                </div>
                <div class="works-gallery__item wow animate__fadeInTopRight" data-wow-duration="500ms">
                    <img class="desk_img full_for_img" src="<?php the_field('services_l_block_of_4_img_pic_desk_4'); ?>" alt="our_works-4">
                    <img class="full_img" src="<?php the_field('services_l_full_img_4'); ?>" alt="our_works-full">
            ...
            <span class="see-more-arrow our-works_services-arrow">
                <a href="<?php the_field('services_l_block_of_4_link_btn'); ?>">
                    <span><?php the_field('services_l_block_of_4_text_btn'); ?></span>
