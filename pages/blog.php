    ...
    <div class="post-preview">
        <div class="post-preview__item wow animate__fadeInLeft" data-wow-duration="500ms">
            <div class="post-preview__item-pic">
                <a href="<?php __FILE__; ?>/pages/post.php">
                    <img src="<?php __FILE__; ?>/assets/images/thumbnails_post/thumbnails-post-1.png" alt="thumbnails-post-1">
                </a>
            </div>
            <a href="<?php __FILE__; ?>/pages/post.php">
        ...
        <div class="post-preview__item wow animate__fadeInUp" data-wow-duration="500ms">
            <div class="post-preview__item-pic">
                <a href="<?php __FILE__; ?>/pages/post.php">
                    <img src="<?php __FILE__; ?>/assets/images/thumbnails_post/thumbnails-post-2.png" alt="thumbnails-post-2">
                </a>
            </div>
            <a href="<?php __FILE__; ?>/pages/post.php">
        ...
        <div class="post-preview__item wow animate__slideInRight" data-wow-duration="500ms">
            <div class="post-preview__item-pic">
                <a href="<?php __FILE__; ?>/pages/post.php">
                    <img src="<?php __FILE__; ?>/assets/images/thumbnails_post/thumbnails-post-3.png" alt="thumbnails-post-3">
                </a>
            </div>
            <a href="<?php __FILE__; ?>/pages/post.php">
