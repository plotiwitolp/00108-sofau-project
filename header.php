...
<head>
    ...
    <link href="<?php __FILE__ ?>/assets/images/favicon.png" rel="shortcut icon" type="image/vnd.microsoft.icon">
    ...
    <link rel="stylesheet" href="<?php __FILE__ ?>/assets/styles/style.css?v=3.1">
    <link rel="stylesheet" href="<?php __FILE__ ?>/assets/styles/responsive.css?v=3.1">
</head>
                ...
                <div class="header">
                    <div class="header-left-top">
                        <div class="header__logo">
                            <a href="<?php __FILE__ ?>/">
                                <img src="<?php __FILE__ ?>/assets/images/logo.svg" alt="wellore.com">
                            </a>
                        </div>
