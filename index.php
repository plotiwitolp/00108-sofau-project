        ...
        <div class="section">
            ...
            <section>
                <div class="main-pic">
                    ...
                    <span class="main-pic__bg">
                        <img src="./assets/images/baner-1-bg.png" alt="baner-1-bg">
                    </span>
                </div>
            ...
            <section>
                <div class="feedback-form">
                    <div class="feedback-form__left">
                        ...
                        <form class="feedback-form__form" action="POST">
                            ...
                            <div class="feedback-form__bottom">
                                <div class="button feedback-form__send">
                                    <button type="submit">Send</button>
                                </div>
                                <div class="feedback-form-pers-data">
                                    <input class="feedback-form-pers-data__check" type="checkbox">
    ...
    <footer>
        <div class="footer-section">
            <div class="section">
                <nav class="footer-nav">
                    <ul>
                        <li class="footer-nav__item">3D Art</li>
                        <li class="footer-nav__item">2D Art</li>
                        <li class="footer-nav__item">Animation</li>
                        <li class="footer-nav__item">Game development</li>
                        <li class="footer-nav__item">Marketing</li>
                        <li class="footer-nav__item">Cinematics</li>
                    </ul>
                </nav>
            </div>
        </div>
        <div class="section">
            <div class="footer-bottom">
                <div class="footer-bottom__mail">contact@wellore.com</div>
                <div class="footer-bottom__socials">
                    <div class="footer-bottom__socials__item">
                        <a href="#">
                            <img src="./assets/images/socials/youtube.svg" alt="youtube">
                        </a>
                    </div>
                    <div class="footer-bottom__socials__item">
                        <a href="#">
                    ...
                    <div class="footer-bottom__socials__item">
                        <a href="#">
                            <img src="./assets/images/socials/facebook-footer.svg" alt="facebook">
                        </a>
                    </div>
                    <div class="footer-bottom__socials__item">
                        <a href="#">
                            <img src="./assets/images/socials/google-plus.svg" alt="google-plus">
                        </a>
                    </div>
                </div>
            </div>
